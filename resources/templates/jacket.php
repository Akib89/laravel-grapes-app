        ...
        <div class="row g-4">
          <div class="col-md-6">
            <div class="product-card">
              <img src="/storage/images/jacket/Padding-Jacket-Olive-1.jpg" alt="Exclusive Padding Jacket">
            </div>
          </div>
          <div class="col-md-6">
            <div class="product-card">
              <img src="/storage/images/jacket/Padding-Jacket-Red-1.jpg" alt="Exclusive Padding Jacket">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="accordion custom-accordion" id="faqAccordion">
        <div class="accordion-item">
          ...
          <div id="q1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
            <div class="accordion-body">এটা Suskin Fabric. আজীবনও রঙ নষ্ট হবে না।</div>
          </div>
        </div>
        ...
        <div class="d-flex justify-content-center">
          <div class="feature-list1">
            ...
            <div class="text-center mt-4">
              <button class="btn btn-custom">অর্ডার করতে চাই</button>
            </div>
                  ...
                  <div class="table-wrapper-2">
                      <table>
                          <tr>
                              ...
                              <th style="color: red;">Width (ইঞ্চি)</th>
                              <th style="color: red;">Length (ইঞ্চি)</th>
                          </tr>
                          <tr>
                              <td>M</td>
                              <td>21</td>
...
<div class="container mb-3">
    ...
    <a href="tel:01619000000" class="contact-btn btn-phone">
      <i class="fas fa-phone"></i> 01619000000
    </a>
    <a href="abc" target="_blank" class="contact-btn btn-whatsapp">
      <i class="fab fa-whatsapp"></i> 01619000000
    </a>
    <a href="xyz" target="_blank" class="contact-btn btn-messenger">

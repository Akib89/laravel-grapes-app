...
<body>
  ...
  <div class="container text-center my-5">
    ...
    <p class="mt-3 fw-bold">
      বাজারের ক্রপি থ্রি পিসের সাথে আমাদের প্রোডাক্ট কে তুলনা করবেন না। আমরা নিজের তত্ত্বাবধানে ইসলামপুরে আমাদের নিজস্ব ফ্যাক্টরিতে মেশিনচালিত করে থাকি। কারণ আমরা সম্পূর্ণ কাপড় নিজেরাই তৈরি করি।
    </p>
    <p class="fw-bold">কাপড়ের ওড়না ও থ্রিপিসের কাপড় সম্পূর্ণ যুক্ত কাপড়।</p>

    <p class="fs-4 fw-bold">
      আজকের অফার মূল্য <span class="text-success">১১০০/=</span> <span class="text-danger">টাকা</span>
    </p>

    <a href="#" class="btn btn-pink px-4 py-2 fw-bold">✅ অর্ডার করতে চাই</a>
  </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        ...
        <div class="col-lg-6 mb-4 mb-lg-0">
          <h2 class="text-magenta fw-bold mb-4">আনস্টিচড ৩ পিস এর বৈশিষ্ট্য</h2>
          <ul class="list-unstyled feature-list">
            <li><span class="tick">✔</span> জামা লং ৪৮ বডি ৫০+</li>
            <li><span class="tick">✔</span> পায়জামা কাপড় দেওয়া ২.৫ গজ (৯০ ইঞ্চি)</li>
            <li><span class="tick">✔</span> ওড়নার কাপড় দেওয়া আছে ৫.৫ হাতা</li>
            <li><span class="tick">✔</span> সম্পূর্ণ অফসান প্রিন্ট করা</li>
            <li><span class="tick">✔</span> ফেব্রিকা কটন সুতি</li>
          </ul>
          <a href="#" class="btn btn-order fw-bold mt-3">
            🛒 অর্ডার করতে চাই
          </a>
        </div>
  ...
  <section class="text-center py-5 bg-white">
    <div class="container">
      <h2 class="fw-bold text-danger mb-4">
        আমাদের মেসেঞ্জারে 24 ঘন্টার প্রতিনিয়ত একজন প্রতিনিধি একটিভ থাকে কোনো সমস্যা হলে সাথে সাথে মেসেঞ্জারে মেসেজ করবেন।
      </h2>
      <div class="d-flex justify-content-center gap-3 flex-wrap">
        <a href="#" class="btn btn-facebook fw-bold px-5 py-4">ফেইসবুক</a>
        <a href="#" class="btn btn-whatsapp fw-bold px-5 py-4">হোয়াটসঅ্যাপ</a>
      </div>
    </div>
  </section>
